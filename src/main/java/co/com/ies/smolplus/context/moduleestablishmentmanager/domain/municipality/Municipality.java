package co.com.ies.smolplus.context.moduleestablishmentmanager.domain.municipality;
...
public class Municipality {
    ...
    public String toString() {
        return "Municipality [id=" + id + ", code=" + code + ", name=" + name + ", daneCode=" + daneCode + ", province="
                + province + "]";
    }
