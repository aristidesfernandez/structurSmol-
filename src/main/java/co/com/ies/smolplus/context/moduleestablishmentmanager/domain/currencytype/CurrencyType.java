package co.com.ies.smolplus.context.moduleestablishmentmanager.domain.currencytype;
...
public class CurrencyType {
    ...
    public String toString() {
        return "CurrencyType [id=" + id + ", name=" + name + ", code=" + code + ", symbol=" + symbol + ", isPriority="
                + isPriority + ", location=" + location + ", exchangeRate=" + exchangeRate + ", decimalPlaces="
                + decimalPlaces + ", decimalSeparator=" + decimalSeparator + ", thousandSeparator=" + thousandSeparator
                + ", description=" + description + ", establishment=" + establishment + "]";
    }
