package co.com.ies.smolplus.context.moduleestablishmentmanager.domain.isle;
...
public class Isle {
    ...
    public String toString() {
        return "Isle [id=" + id + ", description=" + description + ", name=" + name + ", establishment=" + establishment
                + "]";
    }
