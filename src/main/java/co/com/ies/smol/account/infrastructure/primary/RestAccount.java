...
class RestAccount {
  ...
  @Schema(description = "Username of this user", required = true)
  public String getUsername() {
    return username;
  }

  @Schema(description = "Fullname (Firstname LASTNAME) of this user", required = true)
  public String getName() {
    return name;
  }

  @Schema(description = "Email of this user", required = true)
